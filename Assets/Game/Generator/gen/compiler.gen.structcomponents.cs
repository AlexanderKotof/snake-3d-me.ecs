namespace ME.ECS {
    ...
    public static partial class ComponentsInitializer {
        ...
        static partial void InitTypeIdPartial() {
            ...
            WorldUtilities.InitComponentTypeId<Game.Components.DestroyAfterComponent>(false, true, true, false, false, false, false, false, false);
        ...
        static partial void Init(State state, ref ME.ECS.World.NoState noState) {
            ...
            state.structComponents.ValidateUnmanaged<Game.Components.DestroyAfterComponent>(ref state.allocator, false);
    ...
    public static class ComponentsInitializerWorldGen {
        ...
        public static void Init(Entity entity) {
            ...
            entity.ValidateDataUnmanaged<Game.Components.DestroyAfterComponent>(false);
